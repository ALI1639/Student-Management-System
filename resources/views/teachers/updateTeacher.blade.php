...
<form action="{{ route('teachers.update',$teacher->id) }}" method="POST">
    ...
    <div class="row">
        <div class="col-md-6 mb-3">
            ...
            <input type="text" value="{{ $teacher->name }}" name="name" value="{{ old('name') }}"
        ...
        <div class="col-md-6 mb-3">
            ...
            <input type="email" value="{{ $teacher->email }}" name="email" value="{{ old('email') }}"
    ...
    <div class="row">
        <div class="col-md-6 mb-3">
            ...
            <input type="text" value="{{ $teacher->phone }}" name="number" value="{{ old('number') }}"
    ...
    <div class="row">
        ...
        <div class="col-md-6 mb-3">
            ...
            <select name="department_id" class="form-select">
                ...
                <option value="{{ $depart->id }}" {{ $teacher->department_id == $depart->id ? 'selected' : '' }}>
                    {{$depart->name }}
                </option>
                @endforeach
            </select>
    ...
    <div class="row">
        ...
        <div class="col-md-6 mb-3">
            ...
            <select name="status" class="form-select">
                <option value="1" {{ old('status',$teacher->status == 1 ? 'selected' : '') }}>Active
                </option>
